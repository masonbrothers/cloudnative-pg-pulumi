...
export class Subscription extends pulumi.CustomResource {
     ...
     */
    public readonly status!: pulumi.Output<outputs.postgresql.v1.SubscriptionStatus | undefined>;
    ...
    constructor(name: string, args?: SubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["spec"] = args ? (args.spec ? pulumi.output(args.spec).apply(inputs.postgresql.v1.subscriptionSpecArgsProvideDefaults) : undefined) : undefined;
...
export interface SubscriptionArgs {
     ...
     * SubscriptionSpec defines the desired state of Subscription
     */
    spec?: pulumi.Input<inputs.postgresql.v1.SubscriptionSpecArgs>;
    /**
     * SubscriptionStatus defines the observed state of Subscription
     */
    status?: pulumi.Input<inputs.postgresql.v1.SubscriptionStatusArgs>;
}
